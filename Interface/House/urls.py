...
urlpatterns = [
    ...
    path(r'index/selectDir/', views.selectDir),
    path('index/save_canvas_image/', views.save_canvas_image),
    path('index/save_new_data/', views.save_new_data),
    path('index/convert_svg_to_png/', views.convert_svg_to_png),
    path('index/findCommonPart/', views.findCommonPart),
    path('index/save_floorplan_image/', views.save_floorplan_image),

    path('home', views.home),
    path('view3dFloorplan', views.view3dFloorplan),
